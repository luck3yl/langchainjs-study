import { z } from "zod";
import { BaseOutputParser, FormatInstructionsOptions } from "@langchain/core/dist/output_parsers/base.js";
...
export declare class StructuredOutputParser<T extends z.ZodTypeAny> extends BaseOutputParser<z.infer<T>> {
    ...
    lc_namespace: string[];
    toJSON(): import("@langchain/core/dist/load/serializable.js").SerializedNotImplemented;
